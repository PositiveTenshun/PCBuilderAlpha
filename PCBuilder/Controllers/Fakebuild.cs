...
{
    public class Fakebuild : Controller
    {
        ...
        // GET: Fakebuild/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Fakebuild/Create
